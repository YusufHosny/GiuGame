...
constexpr auto qt_meta_stringdata_CLASSPEnemyENDCLASS = QtMocHelpers::stringData(
    "PEnemy",
    "poisonLevelUpdated",
    "",
    "value",
...
constexpr auto qt_meta_stringdata_CLASSProtagonistENDCLASS = QtMocHelpers::stringData(
    "Protagonist",
    "posChanged",
    "",
    "x",
